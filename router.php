...
if (isset($_SESSION['user'])) {
    if ($_SESSION['user']['role'] === 'admin') {
        $routes = [
            ...
            '/verify_otp' => 'controllers/adminlogin/verify_otp.controller.php',
        ];
...
if (!empty($_SESSION['user'])) {
    if ($uri != '/' && $uri != '/form_admin_signin' && $uri != '/form_staff_signin' && $uri != '/staff_forget_password' && $uri != '/admin_forget_password' && $uri != '/verify_otp') {
