            ...
            <form action=" " method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" class="form-control" id="nameInput" required name="reset_password" placeholder="Enter your email" style="width:500px">
                    </div>

                    <div>
                        <label class="font-weight-bold">Comfirm Password</label>
                        <input type="email" name="email" class="form-control" id="nameInput" required name="reset_password" placeholder="Enter your email" style="width:500px">
                    </div>
                </div>
                <div class="row justify-content-between">
                    ...
                    <button class="btn btn-primary my-4 ml-3 align-end">Reset Password</button>
                </div>
            </form>
        </div>
    </div>
