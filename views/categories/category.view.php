<div class="container-fluid">
    <div class="card shadow">
        <div class="card-header pt-3 d-flex justify-content-between">
            ...
            <button type="button" class="btn btn-outline-primary mr-3" data-toggle="modal" data-target="#medalCreate">
                <i class="bi bi-plus-circle mr-2"></i>Add new Category
            </button>
        </div>
        <div class="container pr-1 ml-3 mr-5 mt-4">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="../../controllers/items/create.controller.php" class="d-flex flex-xl-column" method="post">
                                            ...
                                            <span class="text-primary">Description: </span> <?= $cate['cate_desc'] ?>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="controllers/categories/create_category.controller.php" class="d-flex flex-xl-column" method="post">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label for="comment" class="text-primary m-2">Description</label>
